...
#### setup e teardown
Abrir navegador
         Open Browser       http://www.cervelloesmhomolog.com.br/FastTrack/       google chrome
Fechar navegador
        Close Browser

Acessar a página
    Go To    http://www.cervelloesmhomolog.com.br/FastTrack/
...
Clique no modulo catálogo
        click element   xpath=//body[@id='portal']/main/div/section/div[2]/ul/li[2]/div/a/img

###Abra a tela de novo chamado no TMS
  ###    Go To    http://www.cervelloesmhomolog.com.br/FastTrack/Portal/Home
